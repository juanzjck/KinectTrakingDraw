...
public void setTraker( KinectTracker tracker){
...
void draw() {
  ...
  fill(0);
  noStroke();
   float xv=v1.x-direcionx ;
  float yv=v1.y-direciony;
   ellipse(xv,  yv, 10, 10);
  ...
  ellipse(v2.x*direcionx, v2.y*direciony, 20, 20);
*/
  // Display some info
